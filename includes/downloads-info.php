...
================================================================================================
*/
class Rudimentary_Information_Downloads {
    /*
    ============================================================================================
    $transient_base is used to hold data as a transient for a short time.
    ============================================================================================
    */
    public static $transient_base = 'Rudimentary_Information_Downloads_';
    ...
    */
    public static function init() {
        if (null === self::$instance) {
            self::$instance = new Rudimentary_Information_Downloads;
        }
        ...
        if ('' !== $slug) {
            if ($slug) {
                ...
                */
                ...
                ================================================================================
                */
                $theme_transient = Rudimentary_Information_Downloads::$transient_base . $slug;
                ...
                */
                if ($data_timeout && !$data_timeout < time()) {
                    ...
                    */
                    ...
                    ============================================================================
                    */
                    $theme_info = Rudimentary_Information_Downloads::get_remote_theme_info($url, $slug);
                    return $theme_info;
                }
            }
        } else {
                ...
                */
				if (200 === $response['response']['code']) {
                    ...
                    */
                    ...
                    ============================================================================
                    */
					$saved = set_transient(Rudimentary_Information_Downloads::$transient_base . $slug, $theme_info, 60 * 60 * 24);
